...
data class ShapeTokens(
    val cardCornerRadius: androidx.compose.ui.unit.Dp = 36.dp,
    val buttonCornerRadius: androidx.compose.ui.unit.Dp = 24.dp,
    val chipCornerRadius: androidx.compose.ui.unit.Dp = 20.dp,
    val iconCornerRadius: androidx.compose.ui.unit.Dp = 18.dp,
    val dockCornerRadius: androidx.compose.ui.unit.Dp = 100.dp,
    val listItemCornerRadius: androidx.compose.ui.unit.Dp = 20.dp,
    val dialogCornerRadius: androidx.compose.ui.unit.Dp = 40.dp,
)

data class MotionTokens(
    val springStiffness: Float = 800f,
    val springDamping: Float = 0.7f,
    val tweenDuration: Int = 300,
